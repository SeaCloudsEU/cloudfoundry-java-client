...
public class CloudControllerClientFactory2 {
	...
	public CloudControllerClientFactory2(HttpProxyConfiguration httpProxyConfiguration, boolean trustSelfSignedCerts) {
	...
	public CloudControllerClient newCloudController(URL cloudControllerUrl, CloudCredentials cloudCredentials,
		...
		return new CloudControllerClientImpl2(cloudControllerUrl, restTemplate, oauthClient, loggregatorClient,
