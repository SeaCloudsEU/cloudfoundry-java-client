 ...
 */
public class CloudControllerClientImpl2 implements CloudControllerClient {
	 ...
	 */
	protected CloudControllerClientImpl2() {
		logger = LogFactory.getLog(getClass().getName());
	}

	public CloudControllerClientImpl2(URL cloudControllerUrl, RestTemplate restTemplate,
	...
	public CloudControllerClientImpl2(URL cloudControllerUrl, RestTemplate restTemplate,
		...
		logger = LogFactory.getLog(getClass().getName());
		CloudControllerClientImpl2 tempClient =
				new CloudControllerClientImpl2(cloudControllerUrl, restTemplate,
	...
	private CloudSpace validateSpaceAndOrg(String spaceName, String orgName, CloudControllerClientImpl2 client) {
...
//		return userInfo();
	...
	public void getApplications3(String appId) {
		
		//
		// https://api.95.211.172.243.xip.io/v2/apps/7741aade-efdd-4045-8827-5f3ef1b1072e/env
		//
		String url = getUrl(cloudControllerUrl, "/v2/apps/{guid}/env");
		Map<String, Object> urlVars = new HashMap<String, Object>();
		urlVars.put("guid", appId);
	...
	public List<CloudApplication> getApplications2() {
